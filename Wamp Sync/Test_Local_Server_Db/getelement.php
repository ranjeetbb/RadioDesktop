...
{  
	...
	{
	echo $query=mysql_query("insert into doctormobilenumber(doctorId,mobileNumber,alternateMobile1,alternateMobile2,flag) values('$cars7[$x]','$cars8[$x]','$cars9[$x]','$cars10[$x]','$status[$x]')");
	}
}

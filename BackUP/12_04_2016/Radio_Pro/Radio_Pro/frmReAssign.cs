...
namespace Radio_Pro
{
    ...
    {   //for connection
        ...
        private void checkAssign()
        {
            ...
            connect.Open();
            Mycmd = connect.CreateCommand();
            Mycmd.CommandText = "select radioPatientRptDate,radioPatientsName,radioPatientsId,radioDoctorId,radioName,cut,invest,status from csvfile where status=2";
            ...
            if (assignDT.Rows.Count > 0)
            {
                ...
                grdAssignStatus.Columns[7].Name = "Status";
                ...
                foreach (DataRow value in assignDT.Rows)
                {
                    ...
                    string status = value[7].ToString();
                    if(status == "2")
                    {
                        message = "Rejected";
                    }
                    ...
                    row = new string[] { dateValue, (value[1].ToString()), (value[2].ToString()), (value[3].ToString()), (value[4].ToString()), (value[5].ToString()), (value[6].ToString()), message };
        ...
        private void getDataWise()
        {
            ...
            else
            {
                try
                {
                    ...
                    connect.Open();
                    Mycmd = connect.CreateCommand();
                    Mycmd.CommandText = "select radioPatientRptDate,radioPatientsName,radioPatientsId,radioDoctorId,radioName,cut,invest,status from csvfile where radioPatientRptDate between'" + startDate + "'and'" + endDate + "' and status=2";

                    mySelectDA = new MySqlDataAdapter(Mycmd);
                    mySelectDT = new DataTable();
                    mySelectDA.Fill(mySelectDT);
                    updateView = "update csvfile set status=0 where radioPatientRptDate between'" + startDate + "'and'" + endDate + "' and ass_status=2";
        ...
        private void getAreaDateWise()
        {
            ...
            else
            {
                try
                {
                    ...
                    Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.cut, a.invest, a.status FROM csvfile a, doctors b WHERE a.radioPatientRptDate BETWEEN '" + startDate + "' AND '" + endDate + "' AND a.status =2 AND a.radioDoctorId=b.radioDoctorId AND b.areaId ='" + doctname + "'";
                    mySelectDA = new MySqlDataAdapter(Mycmd);
                    mySelectDT = new DataTable();
                    mySelectDA.Fill(mySelectDT);
                    updateView = "update csvfile a, doctors b set a.status=0 WHERE a.radioPatientRptDate BETWEEN '" + startDate + "' AND '" + endDate + "' AND a.status =2 AND a.radioDoctorId=b.radioDoctorId AND b.areaId ='" + doctname + "'";
                    if (mySelectDT.Rows.Count > 0)
                    {
                        lblMessages.ForeColor = System.Drawing.Color.Green;
                        lblMessages.Text = "Data fetched successfully !";
        ...
        private void getAreaDateDoctorWise()
        {
            ...
            else
            {
                try
                {
                    ...
                    mySelectDT = new DataTable();
                    mySelectDA.Fill(mySelectDT);
                    updateView = "update csvfile a, doctors b set a.status=0 WHERE a.radioPatientRptDate BETWEEN '" + startDate + "' AND '" + endDate + "' AND a.status =2 AND a.radioDoctorId=b.radioDoctorId AND b.areaId ='" + doctname + "' and a.radioDoctorId ='" + doctId + "'";
                    if (mySelectDT.Rows.Count > 0)
                    {
                        lblMessages.ForeColor = System.Drawing.Color.Green;
                        lblMessages.Text = "Data fetched successfully !";

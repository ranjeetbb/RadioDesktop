...
namespace Radio_Pro
{
    class Connection_SQL_MySql
    {
        public string getConnectionSql()
        {
            ...
            //string connectionString = "Data Source=DESKTOP-06EPRLJ\\SQLEXPRESS;Initial Catalog=radio;Integrated Security=True;";
            //string connectionString = "Data Source=SERVER\\SQLEXPRESS;Initial Catalog=radio;Integrated Security=True;";
            string connectionString = "Data Source=RANJEETBB;Initial Catalog=radio;Integrated Security=True;";
            //string connectionString = "Data Source=ADMIN-PC;Initial Catalog=radio;Integrated Security=True;";

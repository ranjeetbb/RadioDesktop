...
namespace Radio_Pro
{
    public partial class frmRadioDesktop : Form
    {
        ...
        private void displayAll()
        {
            ...
            Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.invest, c.radioArea, a.cut,a.userName, a.status FROM csvfile a, doctors b, masterarea c WHERE a.radioDoctorId = b.radioDoctorId AND b.areaId = c.radioAreaId";
            ...
            if (mydtCsvFile.Rows.Count > 0)
            {
                ...
                grdDisplayAll.Columns[5].Name = "Investigation";
                grdDisplayAll.Columns[6].Name = "Area";
                grdDisplayAll.Columns[7].Name = "IP";
                grdDisplayAll.Columns[8].Name = "UserName";
                ...
                grdDisplayAll.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;  
                string[] row1;
                string message = "";
                ...
                grdDisplayAll.Sort(grdDisplayAll.Columns[0], ListSortDirection.Ascending);
            }
        ...
        private void displayRejected()
        {
            ...
            connect.Open();
            Mycmd = connect.CreateCommand();
            Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.invest, c.radioArea, a.cut,a.userName, a.status FROM csvfile a, doctors b, masterarea c WHERE a.radioDoctorId = b.radioDoctorId AND b.areaId = c.radioAreaId and a.status=2";
            Mycmd.ExecuteNonQuery();
            MySqlDataAdapter mydaCsvFile = new MySqlDataAdapter(Mycmd);
            DataTable mydtCsvFile = new DataTable();
            mydaCsvFile.Fill(mydtCsvFile);
            ...
            if (mydtCsvFile.Rows.Count > 0)
            {
                ...
                dataGridView1.Columns[5].Name = "Investigation";
                dataGridView1.Columns[6].Name = "Area";
                dataGridView1.Columns[7].Name = "IP";
                dataGridView1.Columns[8].Name = "UserName";
        ...
        private void displayPending()
        {
            ...
            connect.Open();
            Mycmd = connect.CreateCommand();
            Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.invest, c.radioArea, a.cut,a.userName, a.status FROM csvfile a, doctors b, masterarea c WHERE a.radioDoctorId = b.radioDoctorId AND b.areaId = c.radioAreaId and a.status=0";
            Mycmd.ExecuteNonQuery();
            MySqlDataAdapter mydaCsvFile = new MySqlDataAdapter(Mycmd);
            DataTable mydtCsvFile = new DataTable();
            mydaCsvFile.Fill(mydtCsvFile);
            ...
            if (mydtCsvFile.Rows.Count > 0)
            {
                ...
                grdDisplayPending.Columns[5].Name = "Investigation";
                grdDisplayPending.Columns[6].Name = "Area";
                grdDisplayPending.Columns[7].Name = "IP";
                grdDisplayPending.Columns[8].Name = "UserName";
                ...
                grdDisplayPending.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                string[] row1;
                string message = "";
                foreach (DataRow value in mydtCsvFile.Rows)
                {
                ...
                grdDisplayPending.Sort(grdDisplayPending.Columns[0], ListSortDirection.Ascending);
            }
        ...
        private void displayAccepted()
        {
            ...
            connect.Open();
            Mycmd = connect.CreateCommand();
            Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.invest, c.radioArea, a.cut,a.userName, a.status FROM csvfile a, doctors b, masterarea c WHERE a.radioDoctorId = b.radioDoctorId AND b.areaId = c.radioAreaId and a.status=1";
            Mycmd.ExecuteNonQuery();
            MySqlDataAdapter mydaCsvFile = new MySqlDataAdapter(Mycmd);
            DataTable mydtCsvFile = new DataTable();
            mydaCsvFile.Fill(mydtCsvFile);
            ...
            if (mydtCsvFile.Rows.Count > 0)
            {
                ...
                grdDisplayAccepted.Columns[5].Name = "Investigation";
                grdDisplayAccepted.Columns[6].Name = "Area";
                grdDisplayAccepted.Columns[7].Name = "IP";
                grdDisplayAccepted.Columns[8].Name = "UserName";
                ...
                grdDisplayAccepted.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                string[] row1;
                string message = "";
                foreach (DataRow value in mydtCsvFile.Rows)
                {
                ...
                grdDisplayAccepted.Sort(grdDisplayAccepted.Columns[0], ListSortDirection.Ascending);
            }
        ...
        {
            DialogResult result = MessageBox.Show("Are you sure to Exit?", "Confirmation", MessageBoxButtons.YesNo);

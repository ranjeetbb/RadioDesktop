...
namespace Radio_Pro
{
    public partial class frmFetchData : Form
    {
        ...
        {
            someTextBoxOnForm2.Visible = false;
        ...
        private void viewFetchData()
        {
                       ...
                       if (ViewDT.Rows.Count > 0)
                       {
                           ...
                           grdViewFetchData.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                           grdViewFetchData.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                           string[] row;
                           ...
                           grdViewFetchData.Sort(grdViewFetchData.Columns[0], ListSortDirection.Descending);
        ...
        private void btnAssign_Click(object sender, EventArgs e)
        {
            ...
            sendStartDate = startDate;
            sendEndDate = endDate;
            someTextBoxOnForm2.Text = sendStartDate;
           /* MessageBox.Show(sendStartDate);
            frmDirectAssign go_ass = new frmDirectAssign();
            this.Hide();
            go_ass.Show();*/
        ...
        public string TheValue
        {
            get
            {
                return someTextBoxOnForm2.Text; 
            }
        }
      }
 }

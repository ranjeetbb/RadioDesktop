...
namespace Radio_Pro
{
    ...
    {      
        ...
        { 
                       ...
                       Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.radioInvestigation, b.radioArea, a.cut, a.ass_status FROM vwPatientWithDoctorsCut_CSV a, masterarea b WHERE a.areaId = b.radioAreaId AND ass_status =0";
                       ...
                       if (assignDT.Rows.Count > 0)
                       {
                           ...
                           grdAssignStatus.Columns[8].Name = "Assign";
                           ...
                           grdAssignStatus.Columns[8].Visible = false;
                           ...
                           grdAssignStatus.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                           ...
                           foreach (DataRow value in assignDT.Rows)
                           {
                               ...
                               row = new string[] { dateValue, (value[1].ToString()), (value[2].ToString()), (value[3].ToString()), (value[4].ToString()), (value[5].ToString()), (value[6].ToString()), (value[7].ToString()), (value[8].ToString()) };
                       ...
                       else
                       {
                           ...
                           lblMessages.Text = "No records available  ....";
                ...
                if (mySelectDT != null && mySelectDT.Rows.Count > 0)
                {
                    ...
                    var csv = new StringBuilder(); //reading file
                        ...
                        if (mydtCsvFile.Rows.Count > 0)
                        {
                            ...
                            grdCVSFile.Columns[9].Visible = false;
                            ...
                            lblDateArea.Text="";
                            lblDateAreaDr.Text="";
                            lblDateWise.Visible = false;
                            lblDateArea.Visible = false;
                            lblDateAreaDr.Visible = false;
                            File.WriteAllText(@"D:\Radio\" + deviceId + ".csv", csv.ToString());
                            grdCVSFile.Visible = false;
                            grdShowData.Visible = true;
                            lblAssign.ForeColor = System.Drawing.Color.Green;
        ...
        {    
            ...
            Mycmd = connect.CreateCommand();
            Mycmd.CommandText = "SELECT DISTINCT radioName FROM vwpatientwithdoctorscut_csv WHERE areaId ='" + doctname + "' AND radioPatientRptDate BETWEEN  '" + startDate + "' AND  '" + endDate + "' and ass_status =0";
        ...
        private void getDataWise()
        {
            ...
            else
            {
                try
                {
                    lblDateWise.Visible = true;                  
                    lblDateWise.ForeColor = System.Drawing.Color.Blue;
                    //MessageBox.Show("Please Wailt while data updating Do not cllick anywhere");
                    lblDateWise.Text = "Please Wailt while data updating.... !";
                    string startDate = cmbYear.Text + "-" + cmbMonth.Text + "-" + cmdDate.Text;
                    string endDate = cmbYearEnd.Text + "-" + cmbMonthEnd.Text + "-" + cmbDateEnd.Text;
                    ...
                    connect.Open();
                    Mycmd = connect.CreateCommand();
                    Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.radioInvestigation, b.radioArea, a.cut, a.ass_status FROM vwPatientWithDoctorsCut_CSV a, masterarea b WHERE a.areaId = b.radioAreaId AND a.ass_status =0 AND a.radioPatientRptDate BETWEEN  '"+startDate+"' AND  '"+endDate+"'";

                    mySelectDA = new MySqlDataAdapter(Mycmd);
                    mySelectDT = new DataTable();
                    mySelectDA.Fill(mySelectDT);
                    updateView = "update vwPatientWithDoctorsCut_CSV set ass_status=1 where radioPatientRptDate between'" + startDate + "'and'" + endDate + "' and ass_status=0";
                    if (mySelectDT.Rows.Count > 0)
                    {
                        lblDateWise.ForeColor = System.Drawing.Color.Green;
                        lblDateWise.Text = "Data fetched successfully !";
        ...
        private void getAreaDateWise()
        {
            ...
            else
            {
                try
                {
                    ...
                    lblDateArea.Visible = true;
                
                    lblDateArea.ForeColor = System.Drawing.Color.Blue;
                    //MessageBox.Show("Please Wailt while data updating Do not cllick anywhere");
                    lblDateArea.Text = "Please Wailt while data updating.... !";
                    string startDate = cmbYear.Text + "-" + cmbMonth.Text + "-" + cmdDate.Text;
                    string endDate = cmbYearEnd.Text + "-" + cmbMonthEnd.Text + "-" + cmbDateEnd.Text;
                    //MessageBox.Show(startDate +" "+endDate);
                    string get_Myconn = con_sql_mysql.getConnectionMySql();
                    ...
                    Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.radioInvestigation, c.radioArea, a.cut FROM vwPatientWithDoctorsCut_CSV a, doctors b, masterarea c WHERE a.radioPatientRptDate BETWEEN  '" + startDate + "' AND  '" + endDate + "' AND a.ass_status =0 AND a.radioDoctorId = b.radioDoctorId AND b.areaId =  '" + doctname + "' AND b.areaId = c.radioAreaId";
                    mySelectDA = new MySqlDataAdapter(Mycmd);
                    mySelectDT = new DataTable();
                    mySelectDA.Fill(mySelectDT);
                    updateView = "update vwPatientWithDoctorsCut_CSV a, doctors b set a.ass_status=1 WHERE a.radioPatientRptDate BETWEEN '" + startDate + "' AND '" + endDate + "' AND a.ass_status =0 AND a.radioDoctorId=b.radioDoctorId AND b.areaId ='" + doctname + "'";
                    if (mySelectDT.Rows.Count > 0)
                    {
                        lblDateArea.ForeColor = System.Drawing.Color.Green;
                        lblDateArea.Text = "Data fetched successfully !";
                        //MessageBox.Show("Data fetched successfully !");
                        lstUsers.Enabled = true;
                        //btnAssignData.Enabled = true;
                        // grdShowData.DataSource = mySelectDT;
        ...
        private void getAreaDateDoctorWise()
        {
            ...
            else
            {
                try
                {
                    ...
                    lblDateAreaDr.Visible = true;
                    lblDateAreaDr.ForeColor = System.Drawing.Color.Blue;
                    //MessageBox.Show("Please Wailt while data updating Do not cllick anywhere");
                    lblDateAreaDr.Text = "Please Wailt while data updating.... !";
                    string startDate = cmbYear.Text + "-" + cmbMonth.Text + "-" + cmdDate.Text;
                    string endDate = cmbYearEnd.Text + "-" + cmbMonthEnd.Text + "-" + cmbDateEnd.Text;
                    //MessageBox.Show(startDate +" "+endDate);
                    string get_Myconn = con_sql_mysql.getConnectionMySql();
                    ...
                    connect.Open();
                    Mycmd = connect.CreateCommand();
                    Mycmd.CommandText = "SELECT a.radioPatientRptDate, a.radioPatientsName, a.radioPatientsId, a.radioDoctorId, a.radioName, a.radioInvestigation, c.radioArea, a.cut FROM vwPatientWithDoctorsCut_CSV a, doctors b, masterarea c WHERE a.radioPatientRptDate BETWEEN '"+startDate+"' AND '"+endDate+"' AND a.ass_status =0 AND a.radioDoctorId = b.radioDoctorId AND b.areaId = '"+doctname+"' AND b.areaId = c.radioAreaId and a.radioDoctorId ='"+doctId+"'";
                    ...
                    mySelectDT = new DataTable();
                    mySelectDA.Fill(mySelectDT);
                    updateView = "update vwPatientWithDoctorsCut_CSV a, doctors b set a.ass_status=1 WHERE a.radioPatientRptDate BETWEEN '" + startDate + "' AND '" + endDate + "' AND a.ass_status =0 AND a.radioDoctorId=b.radioDoctorId AND b.areaId ='" + doctname + "' and a.radioDoctorId ='" + doctId + "'";
                    if (mySelectDT.Rows.Count > 0)
                    {
                        lblDateAreaDr.ForeColor = System.Drawing.Color.Green;
                        lblDateAreaDr.Text = "Data fetched successfully !";
                        //MessageBox.Show("Data fetched successfully !");
                        lstUsers.Enabled = true;
                        //btnAssignData.Enabled = true;
                        // grdShowData.DataSource = mySelectDT;
